...
class EmailService {
  ...
  async sendBudgetAlert(userEmail: string, userName: string, alert: BudgetAlert): Promise<boolean> {
  ...
  async sendMonthlyReport(userEmail: string, userName: string, reportData: {
    totalSpent: number;
  ...
  private generateBudgetAlertHTML(userName: string, alert: BudgetAlert): string {
  ...
  private generateMonthlyReportHTML(userName: string, reportData: {
    totalSpent: number;
    transactionCount: number;
    topCategory: string;
    reportUrl?: string;
